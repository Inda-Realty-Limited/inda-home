            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2 mb-2">
                  ...
                  {photos.exterior.length === 0 && <div className="aspect-square bg-[#E5F5F4] rounded-xl" />}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2 mb-2">
                  ...
                  {photos.interior.length === 0 && <div className="aspect-square bg-[#E5F5F4] rounded-xl" />}
                </div>
              </div>
            </div>
              ...
              {photos.electrical && (
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-2">
                    ...
                    {photos.electrical.length === 0 && <div className="aspect-square bg-[#E5F5F4] rounded-xl" />}
                  </div>
                </div>
              )}
              ...
              {photos.neighbourhood && (
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-2">
                    ...
                    {photos.neighbourhood.length === 0 && <div className="aspect-square bg-[#E5F5F4] rounded-xl" />}
                  </div>
                </div>
              )}
            </div>
