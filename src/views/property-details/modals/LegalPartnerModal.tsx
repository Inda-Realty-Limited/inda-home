          ...
          <div className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl sm:p-8">
            ...
            <div className="text-center">
              ...
              <p className="mb-6 text-gray-600">
                Thanks {formData.name}! We&apos;ve received your request.
              </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-xs text-gray-600">
                        Our legal partner will reach out
                      </p>
                    </div>
                  </div>
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/50 p-3 sm:p-4">
      <div className="flex min-h-full items-start justify-center py-3 sm:items-center sm:py-6">
        <div className="relative w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl sm:max-w-lg sm:max-h-[calc(100vh-3rem)]">
          <button
            onClick={handleClose}
          ...
          <div className="max-h-[calc(100vh-1.5rem)] overflow-y-auto p-5 sm:max-h-[calc(100vh-3rem)] sm:p-8">
            <div className="mb-6 flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#4ea8a1]/10 sm:h-12 sm:w-12">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Get expert help for your property purchase
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  We&apos;ll call you on this number within 24 hours
                </p>
              </div>
              ...
              <div className="rounded-lg bg-gray-50 p-4">
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="legal-consent" className="text-xs text-gray-700">
                    I agree to be contacted by Inda&apos;s verified legal partners regarding my
                    request. I understand they will call me to discuss my needs and provide a
                    quote.
                  </label>
                </div>
              </div>
