  ...
  if (notFound) {
    ...
    return (
      ...
      >
        <Navbar />
        <main
          className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-[#F9F9F9] via-[#FAFAFA] to-[#F5F5F5] bg-cover bg-center bg-no-repeat min-h-0 relative"
          style={{
          ...
          <div className="max-w-4xl w-full text-center relative z-10">
            ...
            <div className="mb-8 sm:mb-12 lg:mb-16">
              ...
              <div className="mb-6 sm:mb-8 flex justify-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-[#4EA8A1] to-[#66B3AD] rounded-full flex items-center justify-center shadow-lg">
                  <svg
                    className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-white"
                    fill="none"
                    stroke="currentColor"
              ...
              {searchQuery && (
                <div className="mb-4 sm:mb-6">
                  <p className="text-lg sm:text-xl lg:text-2xl font-semibold text-[#4EA8A1] mb-2">
                    "{searchQuery}"
                  </p>
                  {searchType && (
                    <span className="inline-flex items-center bg-[#4EA8A1]/10 border border-[#4EA8A1]/20 rounded-full px-3 py-1 text-sm font-medium text-[#4EA8A1] capitalize">
                      {searchType.replace(/([A-Z])/g, " $1").trim()}
                    </span>
                  )}
                </div>
              )}
              <p className="text-base sm:text-lg lg:text-xl text-[#101820]/70 max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="mb-8 sm:mb-12 lg:mb-16">
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-center">
                <Button
                  variant="primary"
                  onClick={() => router.push("/")}
                  className="text-sm sm:text-base lg:text-lg px-6 sm:px-8 lg:px-10 py-3 sm:py-4 bg-gradient-to-r from-[#4EA8A1] to-[#66B3AD] hover:from-[#3a8a84] hover:to-[#4EA8A1] text-white rounded-xl sm:rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 font-semibold min-w-[200px] sm:min-w-[220px]"
                >
                  Try a different search
                </Button>
                <Button
                  variant="secondary"
                  className="text-sm sm:text-base lg:text-lg px-6 sm:px-8 lg:px-10 py-3 sm:py-4 border-2 border-[#4EA8A1] text-[#4EA8A1] hover:bg-[#4EA8A1] hover:text-white rounded-xl sm:rounded-2xl transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105 font-semibold min-w-[200px] sm:min-w-[220px]"
                >
                  Request a Review
                </Button>
              </div>
            ...
            {/* Error Code */}
            <div className="inline-flex items-center bg-white/80 backdrop-blur-sm border border-[#E5E5E5] rounded-full px-4 sm:px-6 py-2 sm:py-3 shadow-sm">
              <div className="w-2 h-2 bg-[#4EA8A1] rounded-full mr-3 animate-pulse"></div>
              <span className="text-sm sm:text-base text-[#101820]/60 font-medium">
