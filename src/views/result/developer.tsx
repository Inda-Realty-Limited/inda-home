...
const DeveloperResult: React.FC = () => {
        ...
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <section className="bg-[#E5E5E566] rounded-2xl p-6">
            ...
            <div className="flex flex-col items-center mb-6">
              <div className="w-20 h-20 rounded-full bg-[#B8E6E1] flex items-center justify-center mb-3">
                <span className="text-xs font-bold text-[#0A1A22]">LOGO</span>
              </div>
            ...
            <div className="space-y-4 mb-6">
              ...
              <KeyRow
                ...
                value={<span>CAC Records Found</span>}
              />
              <KeyRow
                icon={<FiLayers />}
          ...
          <section className="bg-[#F9F9F9] rounded-2xl p-5 sm:p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
              ...
              />
              <StatPill
                title="⚖️ Legal / Disputes Issues"
                value="No Pending Cases"
              />
            </div>
          </section>
            ...
            <div className="lg:col-span-2 mt-4">
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  ...
                  {
                    name: "Julia Bello",
                    note: "We didn’t eventually buy; there was a 6-month delay. Customer service was helpful when I emailed. I wouldn’t recommend for first-time buyers who need peace of mind.",
                  },
                  {
                    name: "Chukwudi",
          ...
          <section className="bg-[#E5E5E566] rounded-2xl p-5 sm:p-6">
            ...
            <div className="grid grid-cols-2 px-2 sm:px-4 py-2 text-sm font-semibold text-[#101820]">
              <div>Metric</div>
              <div>Value</div>
            </div>
            <div className="divide-y divide-transparent">
              {[
                { m: "Projects Delivered On Time", v: "(8 of 12) 67%" },
                { m: "Price vs. Market Average", v: "+12% premium" },
                { m: "Verified Listings Count", v: "9 with documents checked" },
                { m: "Agent Spread", v: "17 agents affiliated" },
                {
                  m: "Avg ROI from Developer Projects",
                  v: "19.6% over 3 years",
                },
              ].map((row, i) => (
                <div
                  key={i}
                  className="grid grid-cols-2 px-2 sm:px-4 py-3 text-sm"
                >
                  <div className="pr-2">{row.m}</div>
                  <div className="text-[#101820]/80">{row.v}</div>
                </div>
              ))}
            </div>
            <div className="mt-2">
              <button
                className="text-[#4EA8A1] inline-flex items-center gap-1 text-sm"
                onClick={() => setIsAISummaryOpen((v) => !v)}
              >
                AI Summary
                <FiChevronRight
                  className={`w-4 h-4 transition-transform ${
                    isAISummaryOpen ? "rotate-90" : ""
                  }`}
                />
              </button>
              {isAISummaryOpen && (
                <p className="mt-2 text-xs sm:text-sm text-[#101820]/80 leading-relaxed">
                  Out of 7 known projects, 4 have confirmed Certificate of
                  Occupancy, while 2 remain under exclusion. Completed projects
                  saw 18–24% price growth over 3 years.
                </p>
              )}
            </div>
          </section>
