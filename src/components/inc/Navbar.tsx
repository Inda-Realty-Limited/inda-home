  ...
  if (isLoggedIn) {
    ...
    return (
      <XStack className="w-full flex items-center justify-between py-4 bg-inda-dark/90 h-[110px] pr-8">
        ...
        <XStack gap={40} className="items-center space-x-10">
          <div className="flex items-center gap-2 cursor-pointer select-none">
            <FiBell size={32} color="#F9F9F9" />
            <span className="text-white text-lg font-normal">
              Notifications
            </span>
          </div>
          <div className="flex items-center gap-2 cursor-pointer select-none">
            <FiUser size={32} color="#F9F9F9" />
          ...
          <div className="flex items-center gap-2 cursor-pointer select-none">
            ...
            <span className="text-white text-lg font-normal">My Portfolio</span>
          </div>
        </XStack>
      </XStack>
    );
